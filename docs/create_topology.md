...
`manifest`      | string     | Path of the manifest yaml file to create MetalLB in the cluster. The validated manifest for use with KNE can be found [here](https://github.com/davnerson-dn/forked-kne/tree/main/manifests/metallb/manifest.yaml).
...
Field           | Type       | Description
--------------- | ---------- | -----------
`manifest`      | string     | Path of the manifest yaml file to create Meshnet in the cluster. The validated manifest for use with KNE can be found [here](https://github.com/davnerson-dn/forked-kne/tree/main/manifests/meshnet/grpc/manifest.yaml).
...
Field           | Type       | Description
--------------- | ---------- | -----------
`operator`      | string     | Path of the yaml file to create an IxiaTG operator in the cluster. The validated operator for use with KNE can be found [here](https://github.com/davnerson-dn/forked-kne/tree/main/manifests/controllers/keysight/ixiatg-operator.yaml).
`configMap`     | string     | Path of the yaml file to create an IxiaTG config map in the cluster. The validated config map for use with KNE can be found [here](https://github.com/davnerson-dn/forked-kne/tree/main/manifests/controllers/keysight/ixiatg-configmap.yaml).
...
Field           | Type       | Description
--------------- | ---------- | -----------
`operator`      | string     | Path of the yaml file to create an SRLinux operator in the cluster. The validated operator for use with KNE can be found [here](https://github.com/davnerson-dn/forked-kne/tree/main/manifests/controllers/srlinux/manifest.yaml).
...
Field           | Type       | Description
--------------- | ---------- | -----------
`operator`      | string     | Path of the yaml file to create a CEOSLab operator in the cluster. The validated operator for use with KNE can be found [here](https://github.com/davnerson-dn/forked-kne/tree/main/manifests/controllers/ceoslab/manifest.yaml).
...
Field           | Type       | Description
--------------- | ---------- | -----------
`operator`      | string     | Path of the yaml file to create a Lemming operator in the cluster. The validated operator for use with KNE can be found [here](https://github.com/davnerson-dn/forked-kne/tree/main/manifests/controllers/lemming/manifest.yaml).
...
[deploy/kne/kind-bridge.yaml](https://github.com/davnerson-dn/forked-kne/tree/main/deploy/kne/kind-bridge.yaml).
...
proto](https://github.com/davnerson-dn/forked-kne/blob/df91c62eb7e2a1abbf0a803f5151dc365b6f61da/proto/topo.proto#L117),
...
[message](https://github.com/davnerson-dn/forked-kne/blob/df91c62eb7e2a1abbf0a803f5151dc365b6f61da/proto/topo.proto#L26).
...
[examples/multivendor/multivendor.pb.txt](https://github.com/davnerson-dn/forked-kne/blob/main/examples/multivendor/multivendor.pb.txt).
The initial vendor router configs referenced in the topology are found
[here](https://github.com/davnerson-dn/forked-kne/tree/main/examples/multivendor)
