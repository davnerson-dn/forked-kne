...
build {
  ...
  provisioner "shell" {
    inline = [
      ...
      "cd kne",
      "PATH=$PATH:/usr/local/go/bin",
      "/home/$USER/go/bin/go-licenses check github.com/davnerson-dn/forked-kne/kne_cli",
      "/home/$USER/go/bin/go-licenses save github.com/davnerson-dn/forked-kne/kne_cli --save_path=\"../third_party/licenses/kne_cli\"",
      "cd kne_cli",
